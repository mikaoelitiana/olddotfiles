...
function! SpaceVim#layers#test#config() abort
  ...
  call SpaceVim#mapping#space#def('nnoremap', ['k', 'u'], 'lua require("neotest").summary.open()', 'jump-to-summary', 1)
  call SpaceVim#mapping#space#def('nnoremap', ['k', 'U'], 'lua require("neotest").summary.open()', 'open-summary', 1)
  ...
  call SpaceVim#mapping#space#def('nmap', ['k', 'j'], 'lua require("neotest").jump.next({ status = "failed" })', 'jump-to-next-failed', 0)
  call SpaceVim#mapping#space#def('nmap', ['k', 'k'], 'lua require("neotest").jump.prev({ status = "failed" })', 'jump-to-prev-failed', 0)
  call SpaceVim#mapping#space#def('nmap', ['k', 'o'], 'lua require("neotest").output.open({ enter = true })', 'show-output', 0)
